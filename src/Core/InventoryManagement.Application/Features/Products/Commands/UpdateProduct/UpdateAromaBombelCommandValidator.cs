...
/// <summary>
/// Validator for UpdateAromaBombelCommand.
/// Ensures all product data meets business rules and constraints.
/// </summary>
public sealed class UpdateAromaBombelCommandValidator : AbstractValidator<UpdateAromaBombelCommand>
{
    public UpdateAromaBombelCommandValidator()
    {

...
/// <summary>
/// Handler for UpdateAromaBottleCommand.
/// Updates an existing Aroma Bottle product in the database.
/// </summary>
public sealed class UpdateAromaBottleCommandHandler : IRequestHandler<UpdateAromaBottleCommand, Unit>
{
    private readonly IApplicationDbContext _context;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateAromaBottleCommandHandler"/> class.
    /// </summary>
    /// <param name="context">The application database context.</param>
    public UpdateAromaBottleCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    /// <summary>
    /// Handles the UpdateAromaBottleCommand request.
    /// </summary>
    ...
    public async Task<Unit> Handle(UpdateAromaBottleCommand request, CancellationToken cancellationToken)
    {
        // Find the product

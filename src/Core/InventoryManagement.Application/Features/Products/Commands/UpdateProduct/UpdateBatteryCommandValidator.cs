...
/// <summary>
/// Validator for UpdateBatteryCommand.
/// Ensures all product data meets business rules and constraints.
/// </summary>
public sealed class UpdateBatteryCommandValidator : AbstractValidator<UpdateBatteryCommand>
{
    public UpdateBatteryCommandValidator()
    {

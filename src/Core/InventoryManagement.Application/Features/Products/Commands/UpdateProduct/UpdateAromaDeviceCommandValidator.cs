...
/// <summary>
/// Validator for UpdateAromaDeviceCommand.
/// Ensures all product data meets business rules and constraints.
/// </summary>
public sealed class UpdateAromaDeviceCommandValidator : AbstractValidator<UpdateAromaDeviceCommand>
{
    public UpdateAromaDeviceCommandValidator()
    {

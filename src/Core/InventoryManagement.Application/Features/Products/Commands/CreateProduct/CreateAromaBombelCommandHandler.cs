...
/// <summary>
/// Handler for CreateAromaBombelCommand.
/// Creates a new Aroma Bombel product in the database.
/// </summary>
public sealed class CreateAromaBombelCommandHandler : IRequestHandler<CreateAromaBombelCommand, Guid>
{
    private readonly IApplicationDbContext _context;

    /// <summary>
    /// Initializes a new instance of the <see cref="CreateAromaBombelCommandHandler"/> class.
    /// </summary>
    /// <param name="context">The application database context.</param>
    public CreateAromaBombelCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    /// <summary>
    /// Handles the CreateAromaBombelCommand request.
    /// </summary>
    ...
    public async Task<Guid> Handle(CreateAromaBombelCommand request, CancellationToken cancellationToken)
    {

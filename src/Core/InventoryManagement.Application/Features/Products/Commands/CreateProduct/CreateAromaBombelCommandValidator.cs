...
/// <summary>
/// Validator for CreateAromaBombelCommand.
/// Ensures all product data meets business rules and constraints.
/// </summary>
public sealed class CreateAromaBombelCommandValidator : AbstractValidator<CreateAromaBombelCommand>
{
    public CreateAromaBombelCommandValidator()
    {
        RuleFor(x => x.Name)

...
/// Retrieves all products and maps them to their appropriate DTO types.
/// </summary>
public sealed class GetAllProductsQueryHandler : IRequestHandler<GetAllProductsQuery, List<ProductDto>>
{
    ...
    /// Retrieves products and maps them to appropriate DTO types based on their concrete type.
    /// </summary>
    ...
    public async Task<List<ProductDto>> Handle(GetAllProductsQuery request, CancellationToken cancellationToken)
    {
        ...
        // Order by ProductType - cannot order by Name.Value in query, will sort in memory
